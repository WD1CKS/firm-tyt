...
#define USBD_MANUFACTURER_STRING        ((uint8_t *)"Whiskey Lover's Amateur Radio Club")

#define USBD_PRODUCT_HS_STRING          ((uint8_t *)"WD1CKS Virtual ComPort in HS mode")
#define USBD_SERIALNUMBER_HS_STRING     ((uint8_t *)"00000000050B")

#define USBD_PRODUCT_FS_STRING          ((uint8_t *)"WS1CKS Virtual ComPort in FS Mode")
